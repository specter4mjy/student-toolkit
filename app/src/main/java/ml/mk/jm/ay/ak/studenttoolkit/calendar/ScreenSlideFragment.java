...
import ml.mk.jm.ay.ak.studenttoolkit.calendar.helper.CalenderProviderHelper;
...
public class ScreenSlideFragment extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        adapter = new RecyclerViewAdapter(getActivity(), CalenderProviderHelper.getTodayEvents(getActivity(), page+7*weekOffset));
